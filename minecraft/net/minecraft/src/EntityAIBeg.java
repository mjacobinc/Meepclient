...
public class EntityAIBeg extends EntityAIBase
{
    ...
    {
        field_48348_b = worldObject.getClosestPlayerToEntity(theWolf, minPlayerDistance);
    ...
    public boolean continueExecuting()
    {
        ...
        if (theWolf.getDistanceSqToEntity(field_48348_b) > (double)(minPlayerDistance * minPlayerDistance))
        {
            return false;
        }
        else
