...
public class NetClientHandler extends NetHandler
{
    ...
    {
        EntityPlayerSP entityplayersp = mc.thePlayer;
        ((EntityPlayer)(entityplayersp)).capabilities.isFlying = par1Packet202PlayerAbilities.isFlying;
        ((EntityPlayer)(entityplayersp)).capabilities.isCreativeMode = par1Packet202PlayerAbilities.isCreativeMode;
        ((EntityPlayer)(entityplayersp)).capabilities.disableDamage = par1Packet202PlayerAbilities.disableDamage;
        ((EntityPlayer)(entityplayersp)).capabilities.allowFlying = par1Packet202PlayerAbilities.allowFlying;
    }
}
